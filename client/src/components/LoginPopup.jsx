...
const LoginPopup = ({ onClose }) => {
  return (
    <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-gray-800 bg-opacity-0 z-50">
      <div className="bg-white p-8 rounded-md flex flex-col  items-center">
        ...
        <div className="border-2 border-blue-500 rounded-md p-4 mb-4">
          ...
          <Link to ="/register">
          <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg mr-4" onClick={() => console.log("Tenant login clicked")}>Sign Up</button>
          </Link>
        </div>
        ...
        <div className="border-2 border-blue-500 rounded-md p-4">
          ...
          <Link to ="/register">
          <button className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg ml-4" onClick={() => console.log("Tenant login clicked")}>Sign Up</button>
          </Link>
        </div>
        </div>
