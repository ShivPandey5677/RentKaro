...
const PropertyCard = () => {
  return (
    <div className="max-w-md rounded overflow-hidden shadow-2xl bg-gray-800 relative transition duration-300 transform hover:scale-105 my-8 mx-auto">
      ...
      <div className="px-6 py-4 flex flex-col">
        ...
        <div className="flex flex-col">
          <div className="flex felx-col">
            <h2 className="text-gray-300 text-xl">Preferred Tenant:</h2>
            <p className="text-gray-300 px-4 mt-1">Single</p> 
          </div>
          <div className="flex felx-col">
            <h2 className="text-gray-300 text-xl">Rent:</h2>
            <p className="text-gray-300 px-4 mt-1">10000</p> 
          </div>
        </div>
      </div>
    </div>
